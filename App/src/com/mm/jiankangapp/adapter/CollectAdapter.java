...
import com.mm.jiankangapp.api.collects;

public class CollectAdapter extends BaseAdapter {
	private List<collects> list = null;
	private final Context context;
	private LayoutInflater infater = null;
	private final AsyncImageLoader asyncImageLoader;
	private final String serverUrl;

	public CollectAdapter(Context context, List<collects> list) {
	...
	public View getView(final int position, View convertview, ViewGroup parent) {
		...
		holder.tvPrice.setText(" ’≤ÿ ±º‰:" + list.get(position).getCreatetime());
